...
# ─────────────────────────────────────────────────────────────────────────────
def render_login():
    # 1. INTEGRATED CSS BLOCK
    st.markdown("""
    <style>
    /* Full-bleed layout reset */
    ...
    /* Right Panel: Fixed container for Streamlit widgets */
    ...
    /* Centering wrapper to prevent ultra-wide inputs */
    .login-right-wrapper {
        width: 100%;
        max-width: 380px; 
        display: flex;
    ...
    # 3. RIGHT FORM PANEL
    st.markdown('<div class="login-right-wrapper">', unsafe_allow_html=True)
